...
// [AP] made const, will always be 0-255
static const byte cr_none[256] =
...
static const byte cr_zero[256] = {0};

// color tables determined at runtime
...
const boolean constcr[] =
{
    ...
    false, // cr_red
    false, // cr_blue
    true, // const cr_red2blue
    true, // const cr_red2green
    false, // cr_cyan
    true, // const cr_zero
};
